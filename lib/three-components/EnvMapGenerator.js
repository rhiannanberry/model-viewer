...
export default class EnvMapGenerator extends EventDispatcher {
    constructor(renderer) {
        ...
        const sunPosition = new Vector3().set(distance * Math.cos(phi), distance * Math.sin(phi) * Math.sin(theta), distance * Math.sin(phi) * Math.cos(theta));
        this.sky = new Sky();
...
//# sourceMappingURL=EnvMapGenerator.js.map
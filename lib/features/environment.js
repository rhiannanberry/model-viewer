...
export const EnvironmentMixin = (ModelViewerElement) => {
    return class extends ModelViewerElement {
        static get properties() {
            return Object.assign({}, super.properties, { backgroundImage: { type: String, attribute: 'background-image' }, backgroundColor: { type: String, attribute: 'background-color' } });
        }
        ...
        [$setEnvironmentColor](color) {
            ...
            this[$scene].skysphere.material.color.convertGammaToLinear(GAMMA_TO_LINEAR);
